"""
Soughbreighittee - Comprehensive Harm Reduction and Addiction Recovery App for Opiates

A comprehensive tool for Opiate Use Disorder recovery, providing detailed information
and comparison of all known recovery methods with a focus on harm reduction.

WARNING: This application is for informational purposes only and should not replace
